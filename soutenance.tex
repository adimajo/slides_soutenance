...
\vspace*{-0.4cm}
\begin{align*}
\bm{\theta}^\star, \q^\star = & \argmax \mathbb{E}_{\bm{x},y} ln p_{\bm{\theta}}(y \q(\bm{x})) \\
\bm{\theta}^{\text{BIC}}, \q^{\text{BIC}} = & \argmin_{\bm{\theta} \in \bm{\Theta}_{\textcolor{yellow}{\q}}, \textcolor{yellow}{\q \in \bm{Q}}} \text{BIC}(\bm{\theta}; \bm{\mathbf{y}}_\f, \q(\bm{\mathbf{x}_\f))
\end{align*}
\vspace*{-0.2cm}
\end{block}
...
\begin{figure}
\hspace*{-1cm}
\begin{animateinline}[poster=first, controls=all, buttonfg=white]{3}
